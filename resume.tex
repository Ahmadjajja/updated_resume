...
\resumeItem{\textcolor{blue}{\itshape Duolingo English Test:} Successfully {\href{}{\underline{Obtained}} 125/160 Score(Which is equivalent to IELTS 6.5 or higher bands).}}
...
\resumeItem{\textcolor{blue}{\itshape Working experience:} 2+ years as a Software Engineer.}
...
\resumeItem{As a Co-Founder, I'm putting my best efforts with my team into making ecofactor a reality.}
...
\resumeItem{Utilizing these technologies to create EcoFactor: HTML, CSS, Bootstrap 5, JavaScript, React, Python, Flask, LLMs.}
\resumeItemListEnd
...
\resumeProjectHeading
{\textbf{{AI Podcast Generator}} $|$ \emph{HTML, CSS, Bootstrap5, Javascript, React, Generative AI, LLMs, python} $|$ [{\href{https://github.com/Ahmadjajja/AIpodcastgenerator}{\underline{Github link}}}]} {}
\resumeItemListStart
\resumeItem{Developed AI Podcast Generator, an AI-driven tool for transforming written content into engaging audio podcasts.}
\resumeItem{Utilized advanced natural language processing and Eleven Labs speech synthesis for lifelike audio conversion.}
\resumeItem{Simplified podcast creation, eliminating the need for scriptwriting and manual voice recording.}
\resumeItemListEnd
\resumeSubHeadingListEnd
%

...
\resumeItem{Designed a user-friendly interface with secure Firebase authentication.}
\resumeItem{Enabled customizable voice options for personalized podcast creation.}
\resumeItemListEnd
\resumeSubHeadingListEnd
